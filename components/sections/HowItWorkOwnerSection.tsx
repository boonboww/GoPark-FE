...
const steps = [
  {
    ...
    detail:
      "Tạo tài khoản chủ bãi đỗ xe để bắt đầu quản lý và khai thác bãi đỗ trên hệ thống GoPark. Nhận quyền truy cập vào các tính năng quản lý chuyên nghiệp.",
    badge: "Bước 1",
    icon: UserCheck,
  },
  {
    title: "Tạo bãi đỗ",
    detail:
      "Thêm thông tin bãi đỗ xe của bạn: tên, địa chỉ, số lượng chỗ, giá cả... Bãi đỗ sẽ được duyệt và hiển thị cho khách hàng tìm kiếm.",
    badge: "Bước 2",
    icon: ParkingCircle,
  },
  {
    ...
    detail:
      "Theo dõi tình trạng chỗ trống, kiểm soát lượt xe ra vào, cập nhật thông tin bãi đỗ, tối ưu hiệu suất kinh doanh mọi lúc mọi nơi.",
    badge: "Bước 3",
    icon: Building2,
  },
  {
    ...
    detail:
      "Xem lịch sử giao dịch, doanh thu, xuất hóa đơn, quản lý thanh toán và các hoạt động tài chính liên quan đến bãi đỗ xe.",
    badge: "Bước 4",
    icon: DollarSign,
  },
];
        ...
        <AnimatedSection className="text-center mb-16">
          ...
          <AnimatedItem>
            <h2 className="text-4xl md:text-5xl font-bold mb-6 text-gray-900">
              ...
              <span className="text-blue-600">GoPark</span>
            </h2>
          </AnimatedItem>

          <AnimatedItem>
            <p className="text-lg text-gray-700 max-w-3xl mx-auto mb-8 leading-relaxed">
              Khai thác tối đa tiềm năng bãi đỗ xe của bạn với hệ thống quản lý
              thông minh và kết nối với hàng nghìn tài xế mỗi ngày
            </p>
          </AnimatedItem>
        </AnimatedSection>
                  ...
                  <AnimatedItem key={idx} variants={itemVariants}>
                    ...
                    >
                      ...
                      >
                        <IconComponent
                          className={`w-6 h-6 ${
                            active === idx ? "text-white" : "text-blue-600"
                          }`}
                        />
                      </div>
                      <div className="text-left">
                        <span
                          className={`block text-sm font-medium mb-1 ${
                            active === idx ? "text-blue-100" : "text-blue-600"
                          }`}
                        >
                          {step.badge}
                        </span>
                        <span
                          className={`font-semibold ${
                            active === idx ? "text-white" : "text-gray-900"
                          }`}
                        >
                          {step.title}
                        </span>
