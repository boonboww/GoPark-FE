...
export const ParkingCard = ({ parking, onSelect, onNavigate }: ParkingCardProps) => (
  <div className="border border-gray-300 p-3 rounded shadow-sm bg-white cursor-pointer hover:shadow-md transition-shadow"
    ...
    <p className="text-sm text-gray-600">Giá: {parking.pricePerHour.toLocaleString()} VNĐ/giờ</p>
    <p className="text-sm">
      Trạng thái: <span className={parking.isActive ? "text-green-600 font-bold" : "text-red-600 font-bold"}>
