                ...
                <Card key={category.id} className="h-fit">
                  ...
                  <CardContent className="space-y-4">
                    {category.items.map((item, itemIndex) => {
                      const isOpen =
                        openIndex === parseInt(`${categoryIndex}${itemIndex}`);
                      return (
                        <div key={itemIndex} className="border rounded-lg">
                          <button
                            onClick={() =>
                              togglePolicy(
                                parseInt(`${categoryIndex}${itemIndex}`)
                              )
                            }
            ...
            <Card>
              <CardHeader>
                ...
                <p className="text-gray-600">
                  Chia sẻ ý kiến để giúp chúng tôi cải thiện dịch vụ
                </p>
              </CardHeader>
              <CardContent className="space-y-6">
                <div>
                  ...
                  >
                    <SendHorizonal className="w-4 h-4 mr-2 cursor-pointer" />{" "}
                    Gửi phản hồi
                  </Button>
                </div>
                <div>
                  ...
                  <div className="flex flex-col gap-2 mt-4">
                    <Button
                      onClick={() =>
                        (window.location.href = "tel:+84800123456")
                      }
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-blue-800 text-sm leading-relaxed">
                    Chính sách này có hiệu lực từ ngày 1 tháng 8 năm 2025. Việc
                    tiếp tục sử dụng dịch vụ GoPark sau ngày này được xem như
                    bạn đã đồng ý với các điều khoản được cập nhật. Chúng tôi
                    khuyến khích bạn đọc kỹ và liên hệ nếu có thắc mắc.
                  </p>
                </div>
              </div>
            </CardContent>
